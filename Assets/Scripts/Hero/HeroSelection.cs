...
public class HeroSelection : MonoBehaviour
{
    ...
    {
        var orderedHeroes = _heroesPrefab.OrderBy(h => h.HeroInfo.Price).ToList();
    ...
    public void ShowSelectedHero()
    {
        ...
        Hero selectedHero = Heroes.Single(h => h.HeroInfo.Id == PlayerPrefs.GetInt("Hero"));
    ...
    {
        _heroNameDisplay.text = hero.HeroInfo.Name;

        if (_heroPurchasing.IsHeroAlreadyPurchased(hero.HeroInfo.Id))
        {
        ...
        else
        {
            ...
            _heroPriceDisplay.text = hero.HeroInfo.Price.ToString();
        }
    }
    ...
    private void ShowPurchasedHero(Hero hero)
    {
        ...
        if (hero.HeroInfo.Id == PlayerPrefs.GetInt("Hero"))
        {
    ...
    public void SelectHero()
    {
        ...
        PlayerPrefs.SetInt("Hero", hero.HeroInfo.Id);
        _selectButton.SetActive(false);
        _selectedDisplay.SetActive(true);
    }
